			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50" style="width:60%">
						...
						<div class="row">
						<div class="col-50">
							<label for="state">Put a dropdown select for regions in CITY SELECTED</label>
					...
					<div class="col-50">
						...
						<a href="" data-toggle="modal" data-target="#Modal_card"><i class="fa fa-cc-visa" style="color:navy;"></i></a>
