		...
		if($count > 0){
			...
			if (mysqli_query($con,$sql)) {
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Your product is added successfully to your cart..!</b>
					</div>
				";
				exit();
			}
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
                    ...
                    <div class="product-widget">
												<div class="product-img">
													<img src="images/product_images/'.$product_image.'" alt="">
												</div>
												<div class="product-body">
			...
			<form method="post" action="login_form.php">
							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>Thank you for shopping <b> '.$product_title.' </b> in our store. </p>
										</div>
									</div>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-success">Proceed to checkout..</a></td>
								</tr>
							</tfoot>
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="mambichwa1@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-success" value="Proceed to checkout..">
									</form></td>
